...
// Adiciona uma extensão à classe Event para calcular se a duração é curta ou longa
val Event.durationOfEvent: String
    get() = if (this.duration < 60) {  // Se a duração for inferior a 60 minutos
        "short"                        // Marca como "curto"
    } else {
        "long"                         // Caso contrário, marca como "longo"
    }
...
fun main() {
    ...
    // Imprime a duração do primeiro evento do dia usando a extensão criada anteriormente
